...
function InfoCard({
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ pt: 0 }}>
        {" "}
        {/* Remove padding at top to connect with header */}
        {noData ? (
      ...
      if (!initialLoaded || isRefresh) {
        ...
        try {
          ...
          if (typeof responseData === "object" && responseData !== null) {
            ...
            // The API returns { geo: visitorData, weather } instead of flat structure
            const updatedData: Partial<EnhancedVisitorData> = {};
      ...
      <Container maxWidth="lg">
        ...
        <Grid
          ...
          sx={{
            ...
            "& > .MuiGrid-root:nth-of-type(1)": { animationDelay: "0.05s" },
            "& > .MuiGrid-root:nth-of-type(2)": { animationDelay: "0.10s" },
            "& > .MuiGrid-root:nth-of-type(3)": { animationDelay: "0.15s" },
            "& > .MuiGrid-root:nth-of-type(4)": { animationDelay: "0.20s" },
            "& > .MuiGrid-root:nth-of-type(5)": { animationDelay: "0.25s" },
            "& > .MuiGrid-root:nth-of-type(6)": { animationDelay: "0.30s" },
          }}
        >
          {/* IP Address Card */}
          {data.ip ? (
          ...
          {data.weather ? (
            <Grid size={{ xs: 12, md: 6, lg: 4 }}>
              <InfoCard title="Local Weather" icon={<Cloud size={24} />}>
                <Box>
                  <Box
                    sx={{
                      display: "flex",
