...
4. The payload would then inject code into the build process that creates a
...
The compromises of SolarWinds Orion and xz/liblzma demonstrate how attackers can
